...
namespace BilliardGame
{
    public class OgreFramework 
    {
        ...
        public bool InitOgre(string wndTitle)
        {
            ...
            log = LogManager.Singleton.CreateLog("BilliardGame.log", true, true, false);
            ...
            Helper.SetWindowIcon(new System.Drawing.Icon(System.IO.Path.Combine(Environment.CurrentDirectory, "ballIcon.ico")), hwnd);
